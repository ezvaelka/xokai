#!/usr/bin/env bash
# dashboard-export.sh
# Escribe los archivos del dashboard Xokai en el repo local.
# Uso: cd /ruta/a/tu/repo && bash dashboard-export.sh
...
ENDOFFILE
echo "  ✓ src/app/dashboard/LogoutButton.tsx"
...
echo ""
echo "Próximos pasos:"
echo "  git checkout -b claude/build-admin-dashboard-5SNJQ  # si no existe"
echo "  git add src/"
echo "  git commit -m 'feat: admin dashboard Xokai'"
echo "  git push -u origin claude/build-admin-dashboard-5SNJQ"
