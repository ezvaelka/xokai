    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div className="space-y-2">
          <div className="h-7 w-24 bg-xk-subtle rounded-lg animate-pulse" />
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="flex items-center gap-4 px-4 py-4 border-b border-xk-border last:border-0">
            ...
            <div className="flex-1 space-y-1.5">
              <div className="h-4 w-40 bg-xk-subtle rounded animate-pulse" />
              <div className="h-3 w-56 bg-xk-subtle rounded animate-pulse" />
            </div>
            <div className="w-16 h-5 bg-xk-subtle rounded-full animate-pulse" />
          </div>
        ))}
      </div>
    </div>
