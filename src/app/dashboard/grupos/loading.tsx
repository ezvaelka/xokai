  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex gap-3 mb-5">
        <div className="h-9 flex-1 bg-xk-subtle rounded-xl animate-pulse" />
      ...
      <div className="bg-xk-card border border-xk-border rounded-2xl overflow-hidden">
        ...
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="flex items-center gap-4 px-4 py-3.5 border-b border-xk-border last:border-0">
            <div className="w-8 h-8 rounded-lg bg-xk-subtle animate-pulse shrink-0" />
            <div className="flex-1 h-4 bg-xk-subtle rounded animate-pulse" />
            <div className="w-20 h-4 bg-xk-subtle rounded animate-pulse" />
            <div className="w-28 h-4 bg-xk-subtle rounded animate-pulse" />
            <div className="w-10 h-4 bg-xk-subtle rounded animate-pulse" />
            <div className="w-20 h-4 bg-xk-subtle rounded animate-pulse" />
            <div className="w-12 h-4 bg-xk-subtle rounded animate-pulse" />
          </div>
        ))}
      </div>
    </div>
